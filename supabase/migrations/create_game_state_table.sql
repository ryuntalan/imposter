...
-- This file should be executed directly against your Supabase database
...
-- Insert a test record for the problematic room
INSERT INTO game_state (room_id, round, current_stage)
VALUES (
  '2b261041-18f4-4906-9985-36ec28a5f2b2', -- The problematic room ID
  1, -- Round 1
  'discussion_voting' -- Current stage
)
